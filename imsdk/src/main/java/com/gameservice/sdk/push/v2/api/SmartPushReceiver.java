...
public class SmartPushReceiver
    extends
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
            SmartPushReceiver.onNetworkChange();
            try {
            ...
            startSmartPushService(context);
        } else if (action.equals(SmartPushService.HEART_BEAT_ACTION)) {
            Log.d(TAG, "push alarm");
            Intent startIntent = new Intent(context, SmartPushService.class);
