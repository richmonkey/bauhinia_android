...
public class SmartPush implements PushServiceConstants {
    ...
    public static void registerService(Context context) {
        ...
        Intent startIntent = new Intent(appContext, SmartPushService.class);
        appContext.startService(startIntent);

        Intent intent = new Intent(appContext, SmartPushService.class);
